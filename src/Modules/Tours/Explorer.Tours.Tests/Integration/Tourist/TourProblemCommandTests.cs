...
public class TourProblemCommandTests : BaseToursIntegrationTest
{
    ...
    public async void Update_fails_invalid_id()
    {
        ...
        await Should.ThrowAsync<KeyNotFoundException>(async () => await controller.Update(-1000, updatedEntity));
    }
    ...
    public async void Delete_fails_invalid_id()
    {
        ...
        await Should.ThrowAsync<KeyNotFoundException>(async () => await controller.Delete(-1000));
    }
