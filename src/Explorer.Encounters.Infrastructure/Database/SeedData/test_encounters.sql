...
INSERT INTO encounters."Challenges" ("Title", "Description", "Longitude", "Latitude", "XP", "Status", "Type", "CreatorId", "IsCreatedByTourist")
VALUES 
    ('Group Meetup at Park', 'Meet with other tourists at the central fountain', 19.845329, 45.267136, 100, 'Active', 'Social', NULL, false),
    ('Street Performance', 'Gather a crowd for street performance', 19.850123, 45.270234, 150, 'Active', 'Social', NULL, false),
    ('Fitness Group Challenge', 'Join the outdoor fitness group session', 19.833456, 45.260789, 120, 'Active', 'Social', NULL, false),
    ('Picnic Gathering', 'Organize a group picnic', 19.842567, 45.255432, 80, 'Active', 'Social', NULL, false);

-- Insert corresponding Social Encounter configurations
-- Note: Get the actual Challenge IDs after insert, these are examples
